...
CREATE INDEX IF NOT EXISTS idx_users_email ON kmrms.users(email);
CREATE INDEX IF NOT EXISTS idx_users_role ON kmrms.users(role);
CREATE INDEX IF NOT EXISTS idx_patients_user_id ON kmrms.patients(user_id);
CREATE INDEX IF NOT EXISTS idx_medical_records_patient_id ON kmrms.medical_records(patient_id);
CREATE INDEX IF NOT EXISTS idx_medical_records_doctor_id ON kmrms.medical_records(doctor_id);
CREATE INDEX IF NOT EXISTS idx_lab_results_patient_id ON kmrms.lab_results(patient_id);
CREATE INDEX IF NOT EXISTS idx_health_statistics_district ON kmrms.health_statistics(district);
